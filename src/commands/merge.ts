...
export default class Merge extends Command {
  static description = "merge specified branches into an existing monorepo";

  static flags = {
    help: flags.help({ char: "h" }),
    // flag with no value (-c, --config)
    config: flags.string({
      char: "c",
